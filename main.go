...
func main() {
	if os.Getenv("DEBUG") == "true" {
		handleRequest(context.Background(), json.RawMessage(`{"execute": ["FRED_Gather_Today_Release_Indicator_And_Mark_As_Done"]}`)) //  FRED_Gather_Today_Release_Indicator_And_Mark_As_Done
	} else {
